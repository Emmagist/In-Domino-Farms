            ...
            <div class="container-full d-flex justify-content-between align-items-center">            
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    ...
                    <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item">
                            <a href="/" class="nav-link nav-a" data-toggle="dropdown" >Home</a>
                        </li>
                        <li class="nav-item">
                            <a href="about" class="nav-link nav-a" data-toggle="dropdown" >About Us</a>
                        </li>
                        <li class="nav-item">
                            <a href="services" class="nav-link nav-a" data-toggle="dropdown" >Services</a>
                        </li>
                        <li class="nav-item">
                            <a href="contact" class="nav-link nav-a" data-toggle="dropdown" >Contact Us</a>
                        </li>
                        <li class="nav-item">
                            <a href="shop" class="nav-link nav-a" data-toggle="dropdown" >Shop</a>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
